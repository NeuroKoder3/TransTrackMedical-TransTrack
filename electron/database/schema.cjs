...
function createSchema(db) {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS ehr_integrations (
      ...
      ehr_system_type TEXT,
      endpoint_url TEXT,
      auth_type TEXT DEFAULT 'bearer_token',
      enable_bidirectional_sync INTEGER DEFAULT 0,
      sync_fields_to_ehr TEXT,
      auto_create_patients INTEGER DEFAULT 0,
      auto_update_existing INTEGER DEFAULT 1,
      sync_frequency TEXT,
